...
| File Name Date           | *Checkbox*                      | `true`              |                            | NO           | YES        | This is a handler that adds the record date to the name of the downloaded file. Type of date [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601). |
