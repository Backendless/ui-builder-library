...
View an example of how to install this component and how it works in your UI [here](https://app.arcade.software/share/miZ1bY4r1UYVz2IWnx8p).

## Properties

| Property                                   | Type                                                      | Default value | Logic            | Data Binding | UI Setting | Description                                                                                                                                                                            |
|--------------------------------------------|-----------------------------------------------------------|---------------|------------------|--------------|------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Items Data <br> `itemsData`                | *JSON*                                                    | `[]`          | Items Data Logic | YES          | YES        | Specifies a JSON array containing data of the image list items.  Signature of items list: `[ <Item> ]` Signature of item: `{ img: String, title: String, rows: Number, cols: Number }` |
| Layout <br> `layout`                       | *Select* <br> [`standard`, `quilted`, `woven`, `masonry`] | `standard`    |                  | NO           | YES        | Controls the layout of the image list to be used.                                                                                                                                      |
