export default function TotopComponent ({
  ...
  const { style, classList, offset, position, backgroundColor, color, size, padding, element } = component;

  style.backgroundColor = backgroundColor;
  style.padding = padding;
  style.width = size + padding;
  ...
  return (
    <div
      className={ cn('bl-customComponent-totop', classList) }
      style={ style }
