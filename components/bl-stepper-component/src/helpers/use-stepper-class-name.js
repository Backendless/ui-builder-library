const classes = {
  ...
  alternativeLabel: {
    stepper        : 'bl-customComponent-stepper bl-customComponent-stepper--fullwidth',
    item           : 'stepper-alternative-label__item',
    stepTitle      : 'stepper-alternative-label__step-alternative-label-title step-alternative-label-title',
