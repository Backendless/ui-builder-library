...
| Lang <br> `lang`                        | *Select* <br> [Catalan: `ca`, Czech: `cs`, English: `en`, Spanish: `es`, German: `de`, Slovenian: `sl`, Japanese: `ja`, Chinese(Traditional): `zh_tw`, Ukrainian: `uk`, French: `fr`, Italian: `it`, Polish: `pl`, Turkish: `tr`, Danish: `da`, Portuguese(Brazil): `pt_br`, Portuguese: `pt`, Dutch: `nl`, Dutch(Belgium): `nl_be`] | English: `en`                         |                      | NO           | YES        | Controls the language to show `humidity` and `wind speed`.                                                                                                             |
