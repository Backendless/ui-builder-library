...
| closeButtonVisibility | Boolean                                                | `true`        | Close Button Visibility Logic | NO           | YES        | when enabled, the close button is displayed in the component.                                        |
...
|----------------|--------------------------|----------------|
| On Close Event | when the alert is closed |                |
