...
View an example of how to install this component and how it works in your UI [here](https://app.arcade.software/share/EmTrWbbmHUkH0u5pZgNt).
...
| Offscreen Pause <br> `isPausedWhenNotInView`             | *Checkbox*                                                                                                                                                                                                                | `false`                                                                                                                                                                                                                                       |                        | NO           | YES        | Controls the animation stops when it's not in the window view.                                                                                                                                                                                   |
...
<details>
<summary>Try yourself with these states</summary>
