...
| Min Amount         | *Number*   | 0.5           |              |              | YES        | controls the minimum amount that can be charged              |
| Fixed Amount       | *Checkbox* | true          |              |              | YES        | enables to fix the payment amount                            |
| Currency           | *Text*     | USD           |              |              | YES        | controls the currency label                                  |
| Name Visibility    | *Checkbox* | false         |              |              | YES        | enables the visibility of the cardholder name field          |
| Address Visibility | *Checkbox* | false         |              |              | YES        | enables the visibility of the address field                  |
| City Visibility    | *Checkbox* | false         |              |              | YES        | enables the visibility of the city name field                |
| State Visibility   | *Checkbox* | false         |              |              | YES        | enables the visibility of the state name field               |
| Country Visibility | *Checkbox* | false         |              |              | YES        | enables the visibility of the state name field               |
| ZIP Visibility     | *Checkbox* | false         |              |              | YES        | enables the visibility of the postal code or ZIP value field |
