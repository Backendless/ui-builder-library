  ...
  <g transform="translate(76.000000, 82.000000)">
    <g id="Mouth/Concerned" transform="translate(2.000000, 52.000000)">
      ...
      <mask id="MouthMask1" fill="white">
        <use href="#Mouth1" transform="translate(54.003637, 22.500000) scale(1, -1) translate(-54.003637, -22.500000) "/>
      </mask>
      <use
        id="Mouth"
        opacity="0.699999988"
        ...
        href="#Mouth1"/>
      <rect id="Teeth" fill="#FFFFFF" fillRule="evenodd" mask='url("#MouthMask1")' x="39" y="2" width="31" height="16" rx="5"/>
      <g id="Tongue" strokeWidth="1" fillRule="evenodd" mask='url("#MouthMask1")' fill="#FF4F6D">
...
const Disbelief = () => (
  <g transform="translate(76.000000, 82.000000)">
    <g id="Mouth/Disbelief" transform="translate(2.000000, 52.000000)" opacity="0.699999988" fill="#000000">
      <path
        d="M40,15 C40,22.7319865 46.2680135,29 54,29 L54,29 C61.7319865,29 68,22.7319865 68,15"
        id="Mouth"
...
const Eating = () => (
  <g transform="translate(76.000000, 82.000000)">
    <g id="Mouth/Eating" transform="translate(2.000000, 52.000000)">
      <g id="Om-Nom-Nom" opacity="0.599999964" strokeWidth="1" transform="translate(28.000000, 6.000000)" fill="#000000">
        <path
      ...
      <circle id="Redish" opacity="0.2" fill="#FF4646" cx="17" cy="15" r="9"/>
      <circle id="Redish" opacity="0.2" fill="#FF4646" cx="91" cy="15" r="9"/>
    </g>
  </g>
);
...
const Grimace = () => (
  <g transform="translate(76.000000, 82.000000)">
    <g id="Mouth/Grimace" transform="translate(2.000000, 52.000000)">
      ...
      <rect id="Mouth" opacity="0.599999964" fill="#000000" fillRule="evenodd" x="22" y="7" width="64" height="26" rx="13"/>
      <mask id="Grimace-mask1" fill="white">
        <use href="#Grimace-path1"/>
      </mask>
      <use id="Mouth" fill="#FFFFFF" fillRule="evenodd" href="#Grimace-path1"/>
      <path
...
const Sad = () => (
  <g transform="translate(76.000000, 82.000000)">
    <g id="Mouth/Sad" transform="translate(2.000000, 52.000000)" opacity="0.699999988" fill="#000000">
      <path
  ...
  <g transform="translate(76.000000, 82.000000)">
    <g id="Mouth/Scream-Open" transform="translate(2.000000, 52.000000)">
      ...
      <mask id="ScreamOpen-mask1" fill="white">
        <use href="#ScreamOpen-path1" transform="translate(54.000000, 26.999998) scale(1, -1) translate(-54.000000, -26.999998) "/>
      </mask>
      <use
        id="Mouth"
        opacity="0.699999988"
      ...
      <rect id="Teeth" fill="#FFFFFF" fillRule="evenodd" mask='url("#ScreamOpen-mask1")' x="39" y="2" width="31" height="16" rx="5"/>
      <g id="Tongue" strokeWidth="1" fillRule="evenodd" mask='url("#ScreamOpen-mask1")' fill="#FF4F6D">
...
const Serious = () => (
  <g transform="translate(76.000000, 82.000000)">
    <g id="Mouth/Serious" transform="translate(2.000000, 52.000000)" fill="#000000" opacity="0.699999988">
...
const Smile = () => (
  <g transform="translate(76.000000, 82.000000)">
    <g id="Mouth/Smile" transform="translate(2.000000, 52.000000)">
      ...
      <use id="Mouth" opacity="0.699999988" fill="#000000" fillRule="evenodd" href="#Smile-path1"/>
      <rect id="Teeth" fill="#FFFFFF" fillRule="evenodd" mask='url("#Smile-mask1")' x="39" y="2" width="31" height="16" rx="5"/>
...
const Tongue = () => (
  <g transform="translate(76.000000, 82.000000)">
    <g id="Mouth/Tongue" transform="translate(2.000000, 52.000000)">
      ...
      <use id="Mouth" opacity="0.699999988" fill="#000000" fillRule="evenodd" href="#Tongue-path1"/>
...
const Twinkle = () => (
  <g transform="translate(76.000000, 82.000000)">
    <g id="Mouth/Twinkle" transform="translate(2.000000, 52.000000)" opacity="0.599999964" fillRule="nonzero" fill="#000000">
      <path
    ...
    <g id="Mouth/Vomit" transform="translate(2.000000, 52.000000)">
      <defs>
        ...
        <path
          ...
          id="Vomit-path2"/>
        <filter x="-1.4%" y="-2.6%" width="102.8%" height="105.3%" filterUnits="objectBoundingBox" id="Vomit-filter1">
      ...
      <mask id="Vomit-mask1" fill="white">
        <use href="#Vomit-path1" transform="translate(54.000000, 21.499998) scale(1, -1) translate(-54.000000, -21.499998) "/>
      </mask>
      <use
        id="Mouth"
        opacity="0.699999988"
        ...
        href="#Vomit-path1"/>
      <rect id="Teeth" fill="#FFFFFF" fillRule="evenodd" mask='url("#Vomit-mask1")' x="39" y="0" width="31" height="16" rx="5"/>
      <g id="Vomit-Stuff">
        <use fill="#88C553" fillRule="evenodd" href="#Vomit-path2"/>
        <use fill="black" opacity="1" filter='url("#Vomit-filter1")' href="#Vomit-path2"/>
      </g>
    </g>
  </g>
);
