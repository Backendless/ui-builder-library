...
View an example of how to install this component and how it works in your UI [here](https://app.arcade.software/share/1tIEhuFIYOE0ppwD9oZU).
...
| Buttons Settings <br> `buttonsSettings`       | *JSON*                                                                                                                        | [Default Buttons Settings](#default-buttons-settings)                                                                                                                                                             | Buttons Settings Logic    | YES          | YES        | This logic allows to specify the settings of the "Confirm", "Deny", "Cancel" and "Close" buttons.                                                                                                         |
