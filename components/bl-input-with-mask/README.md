...
| Read Only: `readOnly`                      | Checkbox                                                                                                  | `false`              | Read Only Logic            | YES          | YES        | Allows to determine if the input should be read-only.                                                                                                                                                                                                     |
| Disabled: `disabled`                       | Checkbox                                                                                                  | `false`              | Disabled Logic             | YES          | YES        | Allows to determine if the component should be disabled.                                                                                                                                                                                                  |
