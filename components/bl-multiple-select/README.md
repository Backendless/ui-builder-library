...
| Type<br/>`type`                             | Select [Default:`default`<br/>Checkmark:`checkmark`<br/>Chips:`chips`]   | Checkmark:`checkmark`                                                                                                                                                                                                                                                                                                                                |                           | NO           | YES        | This handler allows you to select a type of the component.                                                                                                               |
